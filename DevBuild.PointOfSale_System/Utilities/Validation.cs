...
{
    public enum InformationType { Name = 0, LastName, EmailAddress, TelephoneNumber, Date, Alphanumeric, Alphabetical, Numeric, NumericStrict, ContainsVowels, ContainsPunctuation, ContainsInvalidPunctuation, CustomField }
    ...
    class Validation
    {
        ...
        private const string numericStrictRegexPattern      = @"^[0-9]{1,30}$";
        private const string numericRegexPattern            = @"^([0-9]+([\.]{1})?){1,30}$";
        ...
        private static readonly Dictionary<InformationType, string> InformationRegexes = 
            new Dictionary<InformationType, string> {   { InformationType.Name, nameRegexPattern },
                                                        ...
                                                        { InformationType.NumericStrict, numericStrictRegexPattern},
